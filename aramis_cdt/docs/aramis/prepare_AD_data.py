...
# load data from file containing measured force_ts, etc.
...
load_time = interp1d(time, force_t)
load = load_time(stage_time)

# save data of force_ts as txt file divided by 100. (compatibility with previous data)
